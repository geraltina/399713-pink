...
var pageHeader = document.querySelector(".page-header__width-wrapper");
...
navToggle.addEventListener("click", function (evt) {
  ...
  if (navMenu.classList.contains("main-nav--closed")) {
    ...
    pageHeader.classList.add("page-header__width-wrapper--opened");
  } else {
    navMenu.classList.remove("main-nav--opened");
    navMenu.classList.add("main-nav--closed");
    pageHeader.classList.remove("page-header__width-wrapper--opened");
  }
});
